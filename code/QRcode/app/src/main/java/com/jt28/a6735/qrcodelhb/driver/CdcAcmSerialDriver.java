...
package com.jt28.a6735.qrcodelhb.driver;
            ...
            try {
             ...
             // find the right interface
        		for (int i = 0; i < mDevice.getInterfaceCount(); i++) {
        			...
        			if (mDevice.getInterface(i).getInterfaceClass() == UsbConstants.USB_CLASS_CDC_DATA || mDevice.getInterface(i).getInterfaceClass() == UsbConstants.USB_CLASS_VENDOR_SPEC) {
...
//                Log.d(TAG, "data iface=" + mDataInterface);
    ...
    public static Map<Integer, int[]> getSupportedDevices() {
        ...
        supportedDevices.put(Integer.valueOf(7851),
                new int[] {
                    4870,
                });
